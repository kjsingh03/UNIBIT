...
const unibitTokenAddress = '0x76bc2e765414e6c8b596c0f52c4240f80268f41d';
    ...
    if (typeof window.ethereum !== 'undefined') {
      ...
      window.ethereum.request({ method: 'eth_requestAccounts' })
        .then(accounts => {
          ...
          unibitTokenContract.methods.balanceOf(accounts[0]).call()
            .then(balance => {
              setUnibitBalance(parseInt(balance.toString().split('n')[0])/10**18);
            })
            .catch(error => {
              console.error('Error fetching unibit balance:', error);
            });
        })
        .catch(error => {
