        ...
        <div className='pt-32 h-screen overflow-y-auto'>
            ...
            <div className="flex flex-col gap-12 w-full px-[2rem] md:px-[5rem] xl:px-[11rem] ">
                ...
                <div className="flex flex-col gap-3 transition-all ease-in duration-300">
                    <Accordion handleClick={handleClick} id='ques1' ques="1. What is UIBT?" ans="UIBT is a digital token created by our team. It is used as the primary currency in our online multiplayer betting game." />
                    <Accordion handleClick={handleClick} id='ques2' ques="2. How does the betting game work?" ans="Players can join a game room, place bets using UIBT tokens, and compete against other players. The game outcomes determine the distribution of winnings based on the bets placed." />
